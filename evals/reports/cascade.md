# Eval Report — routing strategy: `cascade`

- **Recipes evaluated:** 5
- **Overall accuracy:** 100.00%
- **Total LLM cost:** $0.0392
- **Total wall-clock latency:** 19719 ms
- **Escalated (cascade only):** 1/5
...
- LLM cost: $0.0167
- Latency: 6706 ms
- Preselected: `claude-haiku-4-5-20251001`  |  Escalated: True
...
| 3 | White Chocolate | Milk Chocolate Cadbury `#4` | $10.00 | 0.50 | 1.00 | ☑️ correct |
